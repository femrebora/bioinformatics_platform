...
interface SnakemakeWorkflowNodeData {
  label: string;
  workflowId: string;
...
interface SnakemakeWorkflowNodeProps {
  id: string;
  data: SnakemakeWorkflowNodeData;
}

const COLOR = "#92400e"; // amber-900

export function SnakemakeWorkflowNode({ id, data }: SnakemakeWorkflowNodeProps) {
